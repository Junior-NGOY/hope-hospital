...
function PatientEdit() {
  const { getPatient, patient,updatePatient, errors} = useContext(PatientContext);
  ...
  const handleUpdatePatient =  (event) => {
    ...
    const patient = JSON.stringify ({ 
      id,prenom, nom,postnom, sexe, datenais,
  ...
  useEffect(() => {
    ...
    setPostNom(patient.postnom);
    setSexe(patient.sexe);
    setLieuNais(patient.lieunais);
    setDateNais(patient.datenais);
    setEtatCivil(patient.etatcivil);
    setTelephone(patient.telephone);
    setProfession(patient.profession);
    setAdresse(patient.adresse);
    setEmail(patient.email);
    setQuartier(patient.quartier);
    setCommune(patient.commune);
    setVille(patient.ville);
    setProvince(patient.province);
    setNationalite(patient.nationalite);
    setPhoto(patient.photo);
    setCategorie(patient.Categorie);
  }, [patient])
  ...
  return (
    ...
    <div className="container-fluid">
      ...
      <div className="col-sm-6">
        <h1>Editer patient</h1>
      </div>
      <div className="col-sm-6">
        <ol className="breadcrumb float-sm-right">
          <li className="breadcrumb-item"><a href="/">Accueil</a></li>
          <li className="breadcrumb-item active">Editer patient</li>
        </ol>
      </div>
      </div>
    </div>
    <div className="card card-primary"> 
    <div className="card-header"><h3 class="card-title">Edition d'un patient {id}</h3></div>
      ...
      <div className="row">
        <div className="col-md-4">
          ...
          <div class="form-group">
            ...
            <input name='lieunais' value={lieunais} onChange={(e) => setLieuNais(e.target.value)} type="" className="form-control" id=" " placeholder="Entre lieu de naissance" />
          </div>
          <div class="form-group">
        ...
        <div className="col-md-4">
          ...
          <div class="form-group">
            ...
            <input name='profession'  value={profession} onChange={(e) => setProfession(e.target.value)} type="text" className="form-control" id=" " placeholder="Entre nom" />
          </div>
          <div class="form-group">
            <label htmlFor="">Téléphone</label>
            <input name='postnom' value={telephone} onChange={(e) => setTelephone(e.target.value)} type="" className="form-control" id=" " placeholder="Entrer Postnom" />
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input name='adresse'  value={adresse} onChange={(e) => setAdresse(e.target.value)} type="text" className="form-control" id=" " placeholder="Entre nom" />
          </div>
          <div class="form-group">
    ...
    <div class="card-footer"><button type="submit" onClick={handleUpdatePatient} className="btn btn-outline-primary">Enregistrer</button>
